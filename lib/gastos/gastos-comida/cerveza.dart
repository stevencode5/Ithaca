...
class Cerveza extends StatefulWidget {
  @override
  _CervezaState createState() => _CervezaState();
}

class _CervezaState extends State<Cerveza> {
  ...
  TextFormField _crearTextFieldCantidad() {
    return TextFormField(
      ...
      autofocus: false,
      decoration: InputDecoration(hintText: 'Cantidad', icon: Icon(Icons.local_drink)),
      validator: (value) =>
          value.isEmpty ? 'Los cantidad no pueden estar vacia' : null,
      onSaved: (value) => this._cantidad = value,
    );
  }
