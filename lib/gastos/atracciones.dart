...
class Atracciones extends StatefulWidget {
  @override
  _AtraccionesState createState() => _AtraccionesState();
}

class _AtraccionesState extends State<Atracciones> {
